...
SEXP TKF91LikelihoodFunction1DMain(SEXP distanceR, SEXP probMatR){
  int ncol, nrow;
...
double TKF91LikelihoodFunction1D(char *seq1sp, char *seq2sp, 
    gsl_matrix *substModel, double len, double Mu, double distance){
